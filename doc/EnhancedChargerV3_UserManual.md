...
> **_WARNING!_** Do not set high charging currents with weak power supplies
...
* When both slots are active, charger current falls back to max 1A and "OL" (overload) sign is shown

> **_WARNING!_** Proper operation is not guaranteed when using an inappropriate power supply or damaged batteries!
